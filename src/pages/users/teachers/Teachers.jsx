...
function Teachers() {
  ...
  const handleStatusChange = async () => {
    ...
    try {
      ...
      message.success(`Teacher status updated to ${selectedStatus}`);
      refetch();
    ...
    return (
      <Card>
        <div className="text-center text-red-500">
          Error loading Teacher: {error.message}
        </div>
      </Card>
    );
  }
  ...
  return (
    <div className="p-4">
      <h2 className="text-center text-2xl font-bold my-5">Teachers List</h2>
